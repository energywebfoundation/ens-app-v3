...
const MOCK_NAMES_FROM_ADDRESS: Name[] = [
  ...
  // unwrapped
  {
    ...
    truncatedName: `unwrapped-unmigrated.${TLD}`,
    type: 'registration',
    isController: true,
    isRegistrant: true,
    isWrappedOwner: true,
  ...
  },
  {
    ...
    truncatedName: `unwrapped-expired.${TLD}`,
    type: 'registration',
    isController: true,
    isRegistrant: true,
    isWrappedOwner: true,
  ...
  },
  {
    ...
    truncatedName: `unwrapped-manager.${TLD}`,
    type: 'registration',
    isController: true,
    isRegistrant: false,
  ...
  },
  {
    ...
    truncatedName: `unwrapped-owner.${TLD}`,
    type: 'registration',
    isController: false,
    isRegistrant: true,
    isWrappedOwner: false,
  ...
  // unwrapped
  {
    ...
    name: `xyz.with-subnames.${TLD}`,
    isMigrated: true,
    parent: {
      name: `with-subnames.${TLD}`,
    },
    createdAt: new Date('2022-11-10T20:19:49.000Z'),
    truncatedName: `xyz.with-subnames.${TLD}`,
    type: 'domain',
    isController: true,
    isRegistrant: false,
    isWrappedOwner: false,
  ...
  },
  {
    ...
    labelhash: '0x9dd2c369a187b4e6b9c402f030e50743e619301ea62aa4c0737d4ef7e10a3d49',
    name: `not-migrated.with-subnames.${TLD}`,
    isMigrated: false,
    parent: {
      name: `with-subnames.${TLD}`,
    },
    createdAt: new Date('2022-11-10T20:19:49.000Z'),
    truncatedName: `not-migrated.with-subnames.${TLD}`,
    type: 'domain',
    isController: true,
    isRegistrant: false,
    isWrappedOwner: false,
  ...
  // wrapped
  {
    ...
    name: `not-expired.wrapped-with-subnames.${TLD}`,
    isMigrated: true,
    parent: {
      name: `wrapped-with-subnames.${TLD}`,
    },
    createdAt: new Date('2023-03-08T20:34:09.000Z'),
    truncatedName: `not-expired.wrapped-with-subnames.${TLD}`,
    type: 'wrappedDomain',
    isController: false,
    isRegistrant: false,
    isWrappedOwner: true,
...
const MOCK_NAMES_FROM_RESOLVED_ADDRESS: Name[] = [
  ...
  },
  {
    ...
    createdAt: new Date('2022-11-10T22:38:40.000Z'),
    owner: '0x70997970c51812dc3a010c7d01b50e0d17dc79c8',
    truncatedName: `resolved-expired.${TLD}`,
    type: 'domain',
  ...
  },
  {
    ...
    labelhash: '0x7b59fa3ae433d72e0be93f61bdeac8122dac0576b2e9f2025c9d6e2561ee1d57',
    name: `resolved-not-migrated.${TLD}`,
    isMigrated: false,
    parent: {
      name: TLD,
    },
    createdAt: new Date('2022-11-10T22:38:40.000Z'),
    owner: '0x70997970c51812dc3a010c7d01b50e0d17dc79c8',
    truncatedName: `resolved-not-migrated.${TLD}`,
    type: 'domain',
    expiryDate: new Date('2023-11-10T22:38:40.000Z'),
    registrationDate: new Date('2022-11-10T22:38:40.000Z'),
    manager: '0x70997970c51812dc3a010c7d01b50e0d17dc79c8',
...
mockUsePrimary.mockReturnValue({ data: { name: `primary.${TLD}` }, isLoading: false })
